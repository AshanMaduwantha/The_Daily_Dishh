...
public class PostService {
    ...
    public ResponseEntity<?> getPosts() {
        ...
        List<PostDTO> postDTOList = buildPostDTOList(posts);
    ...
    public ResponseEntity<?> searchPosts(String keyword) {
        List<Post> posts = postRepository.searchByCaption(keyword);
        List<PostDTO> postDTOList = buildPostDTOList(posts);
        return new ResponseEntity<>(postDTOList, HttpStatus.OK);
    }
    ...
    // Reusable method to convert Posts to PostDTOs
    private List<PostDTO> buildPostDTOList(List<Post> posts) {
        ...
        for (Post post : posts) {
            ...
            for (Comment comment : comments) {
                ...
                commentedUser.ifPresent(cu -> {
                    commentDTO.setUsername(cu.getUsername());
                    commentDTO.setProfileImage(cu.getProfileImage());
                });
